...
import day_1 from '../days/day-1'
import day_2 from '../days/day-2'
import day_3 from '../days/day-3'
import day_4 from '../days/day-4'
import day_5 from '../days/day-5'
import day_6 from '../days/day-6'
import day_7 from '../days/day-7'
import day_8 from '../days/day-8'
import day_9 from '../days/day-9'
import day_10 from '../days/day-10'
import day_11 from '../days/day-11'
import day_12 from '../days/day-12'
import day_13 from '../days/day-13'
import day_14 from '../days/day-14'
    ...
    <>
      <div className="w-100 modalForm">
        <div className="align-center pt-4 pb-6 sm:pt-10 " style={{display: formMessages.messageSent ? 'none' :''}}>
          <h2 className="modal-title" style={{fontSize: "3rem", lineHeight: "1.2", color: "#f4b702"}}>Čestitamo!</h2>
          <h3 style={{fontSize: "1.5rem", color: "#000"}}>Pronašli ste sva jaja i proizvode! Ispunite obrazac i sudjelujte u igri!</h3>
        </div>
        <div className="align-center py-10" style={{display: formMessages.messageSent ? '' :'none'}}>
          <h2 className="mb-2 modal-title" style={{fontSize: "2.3rem", lineHeight: "1.2", color: "#f4b702"}}>Vaša prijava je uspješno zaprimljena! Hvala!</h2>
          {!newsletter ? <h2 style={{color: "#000"}}>Uspješno ste se prijavili na naš newsletter.</h2> : ''}
          <h2 style={{fontSize: "2rem", color: "#000"}}>Sretno!</h2>
         {/*} <a href="https://oetker-shop.hr/" target="_blank" className="basic-button" rel="noreferrer">Posjeti naš WEB SHOP</a>*/}
         <div className="basic-button cursor-pointer" onClick={handleReload}>Resetiraj igru</div>
        </div>
        <form action="." method="POST" onSubmit={handleSubmit} className="mt-4" style={{display: formMessages.messageSent ? 'none' :''}}>
          ...
          <div className="mb-1 flex align-left my-2">
            ...
            <span style={{ fontFamily: 'Roboto Condensed', textAlign: 'left', lineHeight: '1' }} className="pb-1 align-left">Pročitao/la sam i suglasan/sna sam s <a style={{ textDecoration: 'underline' }} href="/Lov na pisanice - Pravila nagradne igre.doc" rel="noreferrer" target="_blank">pravilima nagradne igre.</a></span>
          </div>
          ...
          <div className="mb-1 flex align-center my-2 text-left">
            ...
            <span style={{ fontFamily: 'Roboto Condensed', textAlign: 'left', lineHeight: '1' }} className="pb-1 align-left">Želim se prijaviti na Dr. Oetker newsletter</span>
          </div>
          <div>
        ...
        if(area === "outside") {
          if(clickedIDsOutside.indexOf(target.config.customID) == -1){
            ...
            markersPlugs.updateMarker({
              id: target.config.id,
              tooltip: {
                content: `<h4>Bravo!</h4>Pronađeno <strong>${prevPointsRef.current + 1}</strong> od <strong>${pointsLimit}</strong>!`,
    ...
    return (
      <div className="product-floating-element p-6 flex bg-white rounded-lg shadow-lg cursor-default mb-5 items-center">
        ...
        <div className="pl-6">
          ...
          <a className="product-floating-element__button uppercase font-semibold p-2 block text-center text-white rounded-md mt-4" href={context.product_url} target="_blank">Pročitaj više</a>
        </div>
      </div>
    )
  }
  ...
  return (
    <>
      ...
      <div className="game-section relative">
        ...
        <div className="absolute top-5 right-5 z-100 bodovi-box py-2 px-4 rounded-lg drop-shadow-lg"><h3 className="points-text text-xl md:text-3xl text-white">Bodovi: {points}/{pointsLimit}</h3></div>
        <ReactPhotoSphereViewer
          ref={pSRef}
